...
- Frameworks: transformers, accelerate, bitsandbytes, sentencepiece (4-bit loading). Exact versions are
  pinned inside `kaggle_faithfulness/ontokg_faithfulness_panel.ipynb`.
